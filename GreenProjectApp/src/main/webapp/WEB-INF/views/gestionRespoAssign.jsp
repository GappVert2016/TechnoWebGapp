...
<div class="container text-center">
  ...
  <form:form class="form-horizontal" role="form" modelAttribute="assignEquipeForm" method="POST" action="saveAssign">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <form:input class="form-control" path="idAssignationsEquipe" placeholder=""></form:input>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" >Nom Equipe:</label>
      <div class="col-sm-10">          
        <form:select class="form-control" path="equipe.idEquipe" items="${listEquipes}" itemValue="idEquipe" itemLabel="nomEquipe"></form:select>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" >Eamil Utilisateur:</label>
      <div class="col-sm-10">          
...
<div class="container text-center">
  <table class="table">
    ...
    <tbody>
      <c:forEach items="${listAssigns}" var="assignations">
			<tr class=" info">
			<td>${assignations.equipe.nomEquipe }</td>
			<td>${assignations.utilisateur.nomUtilisateur }</td>
			<td>${assignations.utilisateur.email }</td>
			<td><a href="suppAssign?idAssignationsEquipe=${assignations.idAssignationsEquipe }">Supprimer</a></td>		
			<td><a href="editAssign?idAssignationsEquipe=${assignations.idAssignationsEquipe }">Modifier</a></td>			
			</tr>		
		</c:forEach>
    </tbody>
  </table>
