...
<title>Gestion Responsable | Gestions des Compétences</title>
...
<body>
	...
	<div class="container text-center">
		...
		<form:form class="form-horizontal" role="form"
			modelAttribute="competenceForm" method="POST" action="saveCompetence">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:select class="form-control"
						path="familleCompetence.idFamille" items="${listFamComps}"
						itemValue="idFamille" itemLabel="nomFamille"></form:select>
				</div>
			</div>
			<div class="form-group">
			...
			<tbody>
				<c:forEach items="${listCompetences}" var="assignations">
					<tr class=" info">
						...
						<td><a
							href="suppCompetence?idCompetence=${assignations.idCompetence }">Supprimer</a></td>
						<td><a
							href="editCompetence?idCompetence=${assignations.idCompetence }">Modifier</a></td>
